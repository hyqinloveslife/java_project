...
create table `hr`(
    ...
    `phone` varchar(11) comment '联系电话1',
    `telephone` varchar(20) comment '联系电话2',
    `address` varchar(200) comment '联系地址',
    `enabled` tinyint(11) comment '是否有效',
    `username` varchar(50) comment '用户名', 
    `password` varchar(50) comment '密码',
    `userface` varchar(255) comment '用户接口',
    `remark` varchar(255) comment '备注'
);
alter table `hr` comment '用户表，存放了用户的基本信息';
INSERT INTO `hr` VALUES ('3', '系统管理员', '18568887789', '029-82881234', '深圳南山', '1', 'admin', '123456', 'http://bpic.588ku.com/element_pic/01/40/00/64573ce2edc0728.jpg', null);
INSERT INTO `hr` VALUES ('5', '李白', '18568123489', '029-82123434', '海口美兰', '1', 'libai', '123456', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1514093920321&di=913e88c23f382933ef430024afd9128a&imgtype=0&src=http%3A%2F%2Fp.3761.com%2Fpic%2F9771429316733.jpg', null);
INSERT INTO `hr` VALUES ('10', '韩愈', '18568123666', '029-82111555', '广州番禺', '1', 'hanyu', '123456', 'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1406745149,1563524794&fm=27&gp=0.jpg', null);
INSERT INTO `hr` VALUES ('11', '柳宗元', '18568123377', '029-82111333', '广州天河', '1', 'liuzongyuan', '123456', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1515233756&di=0856d923a0a37a87fd26604a2c871370&imgtype=jpg&er=1&src=http%3A%2F%2Fwww.qqzhi.com%2Fuploadpic%2F2014-09-27%2F041716704.jpg', null);
INSERT INTO `hr` VALUES ('12', '曾巩', '18568128888', '029-82111222', '广州越秀', '1', 'zenggong', '123456', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1517070040185&di=be0375e0c3db6c311b837b28c208f318&imgtype=0&src=http%3A%2F%2Fimg2.soyoung.com%2Fpost%2F20150213%2F6%2F20150213141918532.jpg', null);
...
create table `role`(
    ...
    `nameZh` varchar(64) comment '角色的中文名称'
);
...
create table `menu`(
	`id` int(11) primary key not null auto_increment comment '菜单id',
    `url` varchar(200) comment '地址',
    `path` varchar(200) comment '路径',
    `component` varchar(200) comment '组件名',
    `name` varchar(200) comment '菜单名',
    `iconCls` varchar(200) comment '图标',
    `keepAlive` int(1) comment '是否显示',
    `requireAuth` tinyint(1) comment '是否权限',
    `parentId` int(11) comment '上级菜单id',
    `enabled` tinyint(1) default '1' comment '是否有效' 
);
alter table `menu` comment '菜单-资源表';
...
alter table `menu_role` comment '菜单-角色对应表';
...
create table `hr_role`(
	`id` int(11) primary key not null auto_increment comment '主键id',
    `hr_id` int(11) comment '用户id',
    `rid` int(11) comment '角色id'
);
alter table `hr_role` comment '用户-角色表';
